...
from sanzaru.audio.exceptions import TranscriptionAPIError, TTSAPIError
from sanzaru.infrastructure.openai_client import OpenAIClientWrapper
...
class TestOpenAIClientWrapper:
    ...
    def test_client_initialization_with_api_key(self) -> None:
        ...
        with patch("sanzaru.infrastructure.openai_client.AsyncOpenAI") as mock_openai:
